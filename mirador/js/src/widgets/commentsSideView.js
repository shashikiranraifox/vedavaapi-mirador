(function($) {
    ...
    $.CommentdataView = function(options) {
      ...
      '<div class="title">Comments</div>',
        '<hr>',
          '<div class="comments-buttons">',
            '<button class="annotator-btn">Annotator</button> ',
            '<button class="learner-btn">Learner</button>',
          '</div>',
          '<div class="comment-text">',
              '<p>Lorem ipsum dolor sit amet consectetuer adipiscing elit sed diam nonummy nibh </p>',
              '<div class="comment-details">',
                '<p>by <span>kiran kumar g d</span></p>',
                '<p>24 hours ago</P>',
              '</div>',
              '<div class="icon-holder">',
                '<img src="../images/edit_icon.png" class="annotations-delete-icon"/>',
                '<img src="../images/delete_icon.png" class="annotations-delete-icon"/>',
                '<img src="../images/share_icon.png" class="annotations-delete-icon"/>',
              '</div>',
            '<hr>',
          '</div>',
          '<div class="comment-text">',
          ...
          '<div class="comment-text">',
              '<p>Lorem ipsum dolor sit amet consectetuer adipiscing elit sed diam nonummy nibh </p>',
              '<div class="comment-details">',
                '<p>by <span>kiran kumar g d  jdfvdsbvjhsd  shd shdgv jdgv sdjhgv sdbkfkjdbhhdsv  d dfvbkshdbvjkhbsdv</span></p>',
                '<p>24 hours ago</P>',
              '</div>',
              '<div class="icon-holder">',
                '<img src="../images/edit_icon.png" class="annotations-delete-icon"/>',
