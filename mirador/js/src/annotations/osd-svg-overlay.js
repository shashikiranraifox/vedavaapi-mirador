(function($) {
  $.getTools = function(options) {
    ...
    this.svgOverlayTools = [new $.Rectangle(options), new $.Freehand(options), new $.Polygon(options),new $.Spatial(options),new $.Comment(options), new $.Ellipse(options), new $.Pin(options)];
    return this.svgOverlayTools;
  };
